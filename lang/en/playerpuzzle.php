...
$string['hud_shield_item'] = 'Item representing the Shield consumable';
$string['hud_shield_item_help'] = 'A PlayerHUD item the student can carry into the match as Shield charges: one unit is spent per in-combat Shield use, instead of paying with session coins. Best handed out through reinforcement content rather than earned by playing PlayerPuzzle. Leave unset to keep the coin purchase only.';
$string['hud_sword_item'] = 'Item representing the Sword consumable';
$string['hud_sword_item_help'] = 'A PlayerHUD item the student can carry into the match as Sword charges: one unit is spent per in-combat Sword use (an extra attack), instead of paying with session coins. Best handed out through reinforcement content rather than earned by playing PlayerPuzzle. Leave unset to keep the coin purchase only.';
...
$string['maxconsumables'] = 'Consumable use limit';
$string['maxconsumables_help'] = 'Maximum number of times each consumable type (Potion, Shield, Quick Magic, Sword) can be used per attempt/match, regardless of whether it is bought with session coins or with PlayerHUD stock.';
...
$string['privacy:metadata:ac:consumabletype'] = 'The type of consumable used: potion, shield, magic or sword.';
...
$string['privacy:metadata:coins_spent'] = 'Coins spent on consumable purchases this phase/match.';
