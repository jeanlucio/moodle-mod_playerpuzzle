...
$string['source_ownbank'] = 'PlayerPuzzle\'s own question bank';
$string['source_ownbank_help'] = 'Questions you add or generate yourself for this activity, in addition to (or instead of) the Moodle question bank category above. A "Manage questions" link appears on the Lobby for anyone with the capability, regardless of this setting.';
$string['source_questionbank'] = 'Question bank category';
