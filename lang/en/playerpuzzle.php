...
$string['maxconsumables_help'] = 'Maximum number of times each consumable type (Potion, Shield, Quick Magic, Sword, Question Hint) can be used per attempt/match, regardless of whether it is bought with session coins or with PlayerHUD stock.';
