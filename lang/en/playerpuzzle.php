...
$string['cooldown_label'] = 'Cooldown between matches';
...
$string['cooldownactive'] = 'You can start a new match in {$a}.';
...
$string['hints_enabled_help'] = 'When enabled (default), students can buy and use the Hint consumable for a question that has one configured. When disabled, the Hint option never appears at all, even for a question with a hint.';
...
$string['lobby_difficulty_selected'] = 'Difficulty: {$a}';
$string['lobby_hudcoinbalance'] = 'PlayerHUD: {$a}';
$string['lobby_menu_settings'] = 'Settings';
$string['lobby_menu_shop'] = 'Shop';
$string['lobby_minquestions_notice'] = 'This match requires answering at least {$a} question(s).';
$string['lobby_music_label'] = 'Music';
...
$string['lobby_sfx_label'] = 'Sound effects';
$string['lobby_shop_title'] = 'Loadout Shop';
$string['lobby_speech_label'] = 'Speak game announcements aloud';
...
$string['max_single_matches_help'] = 'How many times the student may attempt this activity. Each attempt is one complete, self-contained match, always fought at the same configured base HP — there are no levels or phases to progress through, unlike Campaign mode. Coins earned carry over between attempts, spendable from the shop before the next one. 0 means unlimited attempts.';
...
$string['privacy:metadata:movelog'] = 'The board swaps and question resolutions made so far during the current phase, kept only for a server-side replay to verify the match.';
...
$string['ranking_empty'] = 'Nobody has scored yet. Play to be the first here!';
$string['ranking_note_campaign'] = 'Points out of 100: a complete campaign is worth 100, counting only verified victories.';
$string['ranking_note_single'] = 'Every match you win adds up to 100 points, counting only verified victories.';
$string['ranking_open'] = 'Ranking';
$string['ranking_points'] = 'Points';
$string['ranking_position'] = 'Position';
$string['ranking_student'] = 'Student';
$string['ranking_title'] = 'Class ranking';
$string['ranking_you'] = '(you)';
...
$string['show_ranking_help'] = 'When enabled, students can open a ranking of the class from the activity page. The ranking uses its own 100-point scale, independent of the grade, and respects separate groups.';
...
$string['victoryunverifiedlost'] = 'Your victory could not be confirmed by the server, and this phase has no restarts left, so this match counts as a defeat.';
$string['victoryunverifiedrestart'] = 'Your victory could not be confirmed by the server, so this phase will restart. Your attempt still counts.';
