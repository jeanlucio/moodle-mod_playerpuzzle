...
$string['lobby_difficulty_help'] = 'Easy halves the boss\'s HP and damage and the coins you earn; Hard doubles the boss and triples the coins. The maximum grade is the same on all three.';
$string['lobby_difficulty_locked'] = 'Difficulty for this run: {$a} (locked while the match is in progress)';
