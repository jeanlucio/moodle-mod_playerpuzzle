...
$string['lobby_difficulty_help'] = 'Fácil reduz pela metade o HP e o dano do Chefe e as moedas que você ganha; Difícil dobra o Chefe e triplica as moedas. A nota máxima é a mesma nas três.';
$string['lobby_difficulty_locked'] = 'Dificuldade desta partida: {$a} (travada enquanto a partida está em andamento)';
