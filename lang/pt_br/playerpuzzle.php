...
$string['privacy:metadata:coins'] = 'A quantidade de moedas que o usuário coletou.';
...
$string['privacy:metadata:playerpuzzle_inventory'] = 'Armazena as moedas e níveis de melhoria acumulados pelo estudante em todas as atividades PlayerPuzzle.';
...
$string['privacy:metadata:shieldlevel'] = 'O nível da melhoria de escudo que o usuário comprou.';
$string['privacy:metadata:status'] = 'O status desta tentativa: em andamento, vitória, derrota, tempo esgotado ou abandonada.';
$string['privacy:metadata:swordlevel'] = 'O nível da melhoria de espada que o usuário comprou.';
