...
$string['source_ownbank'] = 'Banco de questões próprio do PlayerPuzzle';
$string['source_ownbank_help'] = 'Perguntas que você cadastra ou gera você mesmo para esta atividade, além da (ou em vez da) categoria do banco de questões do Moodle acima. Um link "Gerenciar perguntas" aparece no Lobby pra quem tiver a permissão, independente desta configuração.';
$string['source_questionbank'] = 'Categoria do banco de questões';
